...
\begin{itemize}
\item Для любого элементарного языка $n$-кортежей $\formallang{}$
\item существует константа $K > 0$ такая, что
...
Пусть есть некоторая расширяющая АТД-сигнатура и $\formallang{}$~--- элементарный язык $n$-кортежей с ограничениями на размер теремов. Тогда
\begin{itemize}
\item существует константа $K > 0$ такая, что
\item для каждого кортежа термов $\tuple{g_1,\ldots,g_n} \in \formallang{}$,
\item для любого $i$ такого, что $\height{g_i} > K$,
